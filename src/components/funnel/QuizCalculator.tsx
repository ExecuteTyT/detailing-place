...
const SERVICE_PRICES: Record<string, { min: number; max: number }> = {
  "Защита кузова (плёнка, керамика)": { min: 45000, max: 150000 },
  "Полировка и керамика": { min: 15000, max: 60000 },
  "Тонировка": { min: 6000, max: 20000 },
  "Шумоизоляция": { min: 8000, max: 60000 },
  "Тюнинг оптики (Bi-LED)": { min: 10000, max: 30000 },
  "Химчистка салона": { min: 5000, max: 20000 },
  "Другое": { min: 3000, max: 30000 },
};
