      ...
      <div className="container-main">
        ...
        {featured && (
          <Link
            ...
            className="card mt-8 block overflow-hidden md:flex group hover:border-border transition-colors"
          >
            ...
            <div className="p-5 md:p-6 flex flex-col justify-center">
              ...
              <h2 className="mt-2 text-xl md:text-2xl font-bold font-display text-text group-hover:text-text transition-colors">
                {featured.title}
              </h2>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          {rest.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="card overflow-hidden group hover:border-border transition-colors"
            >
              ...
              <div className="p-4">
                ...
                <h3 className="mt-1 font-bold text-text group-hover:text-text transition-colors">
                  {post.title}
                </h3>
