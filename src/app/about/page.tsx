...
import { ShieldCheck, Award, Users, Camera } from "lucide-react";
...
const STATS = [
  { icon: ShieldCheck, value: "1200+", label: "Автомобилей обслужено" },
  { icon: Award, value: "5 лет", label: "Опыт работы" },
  { icon: Users, value: "97%", label: "Клиентов рекомендуют" },
  { icon: Camera, value: "100%", label: "Фотоотчёт каждой работы" },
];
