...
const SERVICES_DATA: SeedService[] = [
  ...
  // 2. Полировка
  {
    ...
    works: [
      ...
      { image: "/images/works/polish-2.webp", car: "BMW 5 Series", tags: ["EXHIBITION", "9H"] },
    ],
  ...
  // 3. Химчистка
  {
    ...
    works: [
      { image: "/images/works/himchistka-1.webp", car: "Toyota Camry", tags: ["Химчистка", "STANDARD"] },
    ],
  ...
  // 6. Тонировка
  {
    ...
    works: [
      { image: "/images/works/tonirovka-1.webp", car: "Toyota Camry", tags: ["Тонировка", "Полный круг"] },
    ],
  ...
  // 7. Установка Bi-LED линз
  {
    ...
    works: [
      { image: "/images/works/linz-1.webp", car: "Kia Ceed", tags: ["Bi-LED", "Комплект"] },
      { image: "/images/works/linz-2.webp", car: "Hyundai Solaris", tags: ["Bi-LED", "Premium"] },
    ],
...
const QUIZ_CATEGORIES_DATA = [
  "Защита кузова (плёнка, керамика, антидождь)",
  "Полировка (кузов, фары, стёкла)",
  "Тонировка и антихром",
  "Шумоизоляция",
  "Оптика (линзы, регулировка фар)",
  "Химчистка салона",
  "Русификация / ремонт вмятин",
];
