...
const SETTINGS_DATA: { key: string; value: string }[] = [
  { key: "phone", value: "+7 (843) 000-00-00" },
  { key: "phone_raw", value: "78430000000" },
  { key: "whatsapp_url", value: "https://wa.me/78430000000" },
...
const SERVICES_DATA: SeedService[] = [
  ...
  // 13. Ремонт вмятин PDR
  {
    ...
    hasBeforeAfter: false,
    showOnHomepage: false, // excluded from homepage
  },
...
const TEAM_DATA = [
  { name: "Руслан", role: "Основатель, мастер PPF", image: "/images/team-1.jpg" },
  { name: "Марат", role: "Мастер полировки", image: "/images/team-2.jpg" },
  { name: "Артём", role: "Электрика, Bi-LED", image: "/images/team-3.jpg" },
  { name: "Дамир", role: "Шумоизоляция", image: "/images/team-4.jpg" },
];
...
const PORTFOLIO_DATA = [
  { slug: "bmw-x5-ppf", car: "BMW X5", serviceName: "Оклейка PPF — Полный фронт", image: "/images/works/ppf-1.jpg", tags: ["PPF"] },
  { slug: "mercedes-gle-ppf", car: "Mercedes GLE", serviceName: "PPF + Керамика", image: "/images/works/ppf-2.jpg", tags: ["PPF", "Керамика"] },
  { slug: "porsche-cayenne-ppf", car: "Porsche Cayenne", serviceName: "PPF зоны риска", image: "/images/works/ppf-3.jpg", tags: ["PPF"] },
  { slug: "mercedes-c-polish", car: "Mercedes C-Class", serviceName: "Полировка + Керамика", image: "/images/works/polish-1.jpg", tags: ["Полировка"] },
  { slug: "bmw-5-polish", car: "BMW 5 Series", serviceName: "Exhibition полировка", image: "/images/works/polish-2.jpg", tags: ["Полировка"] },
  { slug: "kia-ceed-linz", car: "Kia Ceed", serviceName: "Установка Bi-LED линз", image: "/images/works/linz-1.jpg", tags: ["Bi-LED"] },
  { slug: "hyundai-solaris-linz", car: "Hyundai Solaris", serviceName: "Bi-LED Premium", image: "/images/works/linz-2.jpg", tags: ["Bi-LED"] },
  { slug: "bmw-x3-antihrom", car: "BMW X3", serviceName: "Антихром Full Black", image: "/images/works/antihrom-1.jpg", tags: ["Антихром"] },
  { slug: "toyota-camry-tonirovka", car: "Toyota Camry", serviceName: "Тонировка полный круг", image: "/images/works/tonirovka-1.jpg", tags: ["Тонировка"] },
  { slug: "toyota-camry-himchistka", car: "Toyota Camry", serviceName: "Химчистка STANDARD", image: "/images/works/himchistka-1.jpg", tags: ["Химчистка"] },
  { slug: "zeekr-001-ceramica", car: "Zeekr 001", serviceName: "Керамика 9H", image: "/images/works/polish-1.jpg", tags: ["Керамика"] },
  { slug: "haval-jolion-rusifikaciya", car: "Haval Jolion", serviceName: "Русификация + навигация", image: "/images/works/linz-1.jpg", tags: ["Русификация"] },
];
